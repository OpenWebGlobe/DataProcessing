...
%PYTHON% %CLOSURE_LIBRARY%\closure\bin\build\closurebuilder.py ^
 ...
 --compiler_flags=--create_source_map=..\compiled\mapnikrenderer-optimized.map ^
 ...
 --namespace=owg.process.MapnikRenderer ^
 --output_file=..\compiled\mapnikrenderer-optimized.js ^
