...
int main(int argc, char *argv[])
{
   ...
   std::string sLayer;
   bool bError = false;
   Img::FileFormat eFileformat = Img::Format_PNG;
   std::string sFileExtention = ".png";
   std::string sFormat;
   bool bVerbose = false;
   ...
   {
      sFormat = vm["format"].as<std::string>();
      if (sFormat == "png")
      {
         eFileformat = Img::Format_PNG;
         sFileExtention = ".png";
      }
      else if (sFormat == "jpg")
      {
         eFileformat = Img::Format_JPG;
         sFileExtention = ".jpg";
      }
      else
      {
